<div>
    <div class="flex flex-col gap-6 w-[400px] mx-auto py-16">
        <select wire:model="selectedContinent" wire:change="changeContinent" class="single-select2" data-search="1">
        ...
        <div class="flex relative">
            ...
            <select wire:model="selectedCountry" class="flex-1" class="single-select2" data-search="1">
